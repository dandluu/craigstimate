...
class DataForm(FlaskForm):
    ...
    bed = SelectField(validators=[DataRequired()], choices=[i for i in range(0,6)], label='Number of Beds (0 = Studio)')
    bath = SelectField(validators=[DataRequired()], choices=[i for i in range(1, 6)], label='Number of Bathrooms')
